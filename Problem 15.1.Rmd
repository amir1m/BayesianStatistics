...
```{r}
cat("\nmu_t Error:")
cat("\n   RWM Error: ", mean(lRWMsamplesWarmed[,1]) - 20)
cat("\n   Gibbs Error:", mean(lGibbsSampleWarmed[,1]) - 20)

cat("\nmu_c Error:")
cat("\n   RWM Error: ", mean(lRWMsamplesWarmed[,2]) - 5)
cat("\n   Gibbs Error:", mean(lGibbsSampleWarmed[,2]) - 5)

```

```{r}
sd(lRWMsamplesWarmed[,1])/sqrt(length(lRWMsamplesWarmed[,1]))
```
